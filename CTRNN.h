...
class CTRNN {
    public:
        ...
        void EulerStepTwoWayLesionedEdge(double stepsize, int from, int to, double outputFrom, double outputTo);
        void EulerStepOneWayLesionedEdge(double stepsize, int from, int to, double outputFrom);
