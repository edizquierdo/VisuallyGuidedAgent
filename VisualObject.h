...
class VisualObject {
  public:
    // The constructor
    VisualObject(double ix = 0.0, double iy = 275.0, double v_ = -3.0, double a_ = 0.0, double size_ = 30.0) {
      cx = ix; cy = iy;
      v = v_;
      a = a_;
      size = size_;
    ...
    // Accessors
    void SetPositionX(double x_) {cx = x_;};
    void SetPositionY(double y_) {cy = y_;};
    void SetSize(double s_) {size = s_;};
    void SetVel(double v_) {v = v_;};
    void SetAngle(double a_) {a = a_;};
...
public:
  ...
  Line(double ix = 0.0, double iy = 275.0, double v_ = -3.0, double a_ = 0.0, double size_ = 30.0)
    : VisualObject(ix,iy,v_,a_,size_) {};
...
public:
  // The constructor
  // size --> diameter
  Circle(double ix = 0.0, double iy = 275.0, double v_ = -3.0, double a_ = 0.0, double size_ = 30.0)
    : VisualObject(ix,iy,v_,a_,size_) {};
